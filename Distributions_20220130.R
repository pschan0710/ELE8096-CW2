...
# Box plot for PM2.5
boxplot(belfastdata$PM2.5, horizontal=TRUE, main="Box Plot of PM2.5")

# Box plots for all pollutants
boxplot(pollutants[,-1], horizontal=TRUE, main="Sensor System average 1 hour for pollutants")

# Histogram for PM2.5
hist(belfastdata$PM2.5, breaks=10)
